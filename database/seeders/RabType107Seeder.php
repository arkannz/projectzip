...
class RabType107Seeder extends Seeder
{
    public function run()
    {
        // Cari type 107 dari database
        $type = Type::where('nama', '107')->first();
        
        if (!$type) {
            echo "⚠ Type 107 tidak ditemukan! Jalankan TypeSeeder terlebih dahulu.\n";
            return;
        }
        ...
        $data = [
            ...
            // N — ACI MINIMALIS
            ['N', 'Semen TR-30 40 Kg Tiga Roda', 24],
        ...
        echo "✔ SELESAI — DATA TYPE 107 BERHASIL DIIMPORT ($inserted item)\n";
